...
class ExplicadorFilterByEndDataTest {
    ...
    void filter() {
        ...
        ExplicadorFilterByEndData explicadorFilterByEndData= new ExplicadorFilterByEndData(disponibilidadeBuilder.build().getFim());
        assertEquals(1,explicadorFilterByEndData.filter(explicadors).size());

        explicadorFilterByEndData= new ExplicadorFilterByEndData(null);
        assertEquals(2,explicadorFilterByEndData.filter(explicadors).size());
    }
}