...
public class Disponibilidade {
    ...
    public Disponibilidade(LocalTime inicio, LocalTime fim, DayOfWeek diaDaSemana, Set<Explicador> explicadors) {
        this.inicio = inicio;
        this.fim = fim;
    ...
    private boolean contains(LocalTime start, LocalTime end) {
        return (this.inicio.isBefore(start) || this.inicio.equals(start)) && (this.fim.isAfter(end) || this.fim.equals(end));
    }
}
